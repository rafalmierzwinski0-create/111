...
class LSTAB_Icons {
	...
	protected static function paths() {
		return array(
			...
			'globe'    => '<circle cx="12" cy="12" r="8.6"></circle><path d="M3.4 12h17.2"></path><path d="M12 3.4c2.2 2.3 3.4 5.3 3.4 8.6S14.2 18.3 12 20.6c-2.2-2.3-3.4-5.3-3.4-8.6S9.8 5.7 12 3.4z"></path>',
